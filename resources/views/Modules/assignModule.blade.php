      ...
      @if(session('success'))
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="{{ route('saveassignmoduleRole') }}">
                @csrf
              <div class="box-body">
              ...
              <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                  ...
                  <select id="select-state" class="form-control" name="module_name" >
                                    <option value="">Choose...</option>
                                    @foreach($modules as $pd)
                                    <option value="{{ $pd->id }}" {{ ($modulex == $pd->id || old("module_name") == $pd->id )? "selected" :"" }}>{{$pd->moduleName}} </option>
                                    @endforeach
                                </select> 
                </div>
...
<script>
    function deleteRecord(x)
    {
        ...
        if(i==true)
        {
            document.location = "/delete-assign-module/"+x;
        }
    }
</script>
