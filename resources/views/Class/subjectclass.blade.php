      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          @if(session('success'))
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="{{ route('assignSubject') }}">
                @csrf
              <div class="box-body">
                ...
                <div class="form-group col-md-6">
                  ...
                  <select id="class" class="form-control" name="subject" >
                                    ...
                                    <option value="{{ $s->id }}" {{ ($subjectx == $s->id || old("subject") == $s->id )? "selected" :"" }}>{{$s->subject}} </option>
                                    @endforeach
                    </select>
                </div>
        ...
        <hr>
            <div class="table-responsive">
                <table class="table table-bordered">
                  ...
                  <tbody>
                  @php $i=1;  @endphp
                  @foreach($classsubject as $details)
                  <tr>
                   <td>{{ $i++ }}</td>
                    <td>{{  $details->class }}</td>
...
$("#class").change(function(e){
    ...
    document.location="/load-subject-class/"+ class_id;
    //ajax
